...
<body>
    ...
    <ul>
      <div class="main-row"><li style="float:right"><a href="<?php echo base_url()?>index.php/Aktakelahiran">Kembali</a></li></div>
    </ul>
...
<?php
  ...
  <div class="main">
    ...
    <form action="<?php echo base_url()?>index.php/AktaKelahiran/daftarkelahiran1" method="POST">
      <table>
