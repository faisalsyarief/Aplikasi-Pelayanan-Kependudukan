    ...
    <section class="content">
        <div class="col-md-12">
          ...
          <?php echo form_open_multipart('Aktakematian/simpanedit/'.$id)?> 
                <br>
                      <input id="nikk" name="nikk" value="<?php echo $row->nik_kematian; ?>" type="hidden" required>
                      <input id="nmkepl" name="nmkepl" rows="2" cols="130,9" value="<?php echo $row->nm_kepala; ?>" type="hidden" required>
                      <input id="nmibu" name="nmibu" value="<?php echo $row->nm_ibu; ?>" type="hidden" required>
                      <input id="nml" name="nml" value="<?php echo $row->nama_lengkap; ?>" type="hidden" required>
                      <input id="jns" name="jns" value="<?php echo $row->jenis_klm; ?>" type="hidden" required>
                      <input id="tgll" name="tgll" value="<?php echo $row->tanggl_lahir; ?>" type="hidden" required>
                      <input id="tmpt" name="tmpt" value="<?php echo $row->tmpt_lahir; ?>" type="hidden" required>
                      <input id="agm" name="agm" value="<?php echo $row->agama; ?>" type="hidden" required>
                      <input id="alamt" name="alamt" value="<?php echo $row->alamt; ?>" type="hidden" required>
                      <input id="ank" name="ank" value="<?php echo $row->ankke; ?>" type="hidden" required>
                      <input id="tglk" name="tglk" value="<?php echo $row->tgl_kematian; ?>" type="hidden" required>
                      <input id="sbb" name="sbb"  value="<?php echo $row->sebab_kematian; ?>" type="hidden" required>
                      <input id="tmptk" name="tmptk" rows="2" value="<?php echo $row->tmpt_kematian; ?>" type="hidden" required>
                ...
                <div class="form-group">
                  ...
                  <div class="box box-info">
                    ...
                    <div class="box-body pad">
                      <input type="radio" id="statuss" value="Selesai" name="statuss" required><label class="light">Selesai</label><br>
                      <input type="radio" id="statuss" value="Belum Selesai" name="statuss" required><label class="light">Belum Selesai</label><br>
                      <input type="radio" id="statuss" value="Tertunda" name="statuss" required><label class="light">Tertunda</label>
                    </div>
                  </div>
                  </div>
                </div>
