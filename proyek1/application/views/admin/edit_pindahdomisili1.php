            ...
            <div class="outter-wp">
                  <div class="sub-heard-part">
                     <ol class="breadcrumb m-b-0">
                      ...
                      <li class="active">Edit Data Tujuan</li>
                    </ol>
                     </div>
                                    ...
                                    <?php
                                            if(isset($data_pindahkeluar1)){
                                                foreach($data_pindahkeluar1 as $row){
                                                  $id = $row->id_tujuan;
                                            ?>
          <?php echo form_open_multipart('Pindahdomisili1/simpanedit/'.$id)?> 
                <br>
                <div class="form-group">
                  ...
                  <div class="box box-info">
                    ...
                    <div class="box-body pad">
                      <textarea id="almtt" name="almtt" rows="2" cols="130,9" value="<?php echo $row->almt_tjuan; ?>" required><?php echo $row->almt_tjuan; ?></textarea>
                    </div>
                  </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="box box-info">
                    ...
                    <div class="box-body pad">
                      <textarea id="rtrww" name="rtrww" rows="2" cols="130,9" value="<?php echo $row->rt_rww; ?>" required><?php echo $row->rt_rww; ?></textarea>
                    </div>
                  </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="box box-info">
                    ...
                    <div class="box-body pad">
                      <textarea id="prov" name="prov" rows="2" cols="130,9" value="<?php echo $row->provinsii; ?>" required><?php echo $row->provinsii; ?></textarea>
                    </div>
                  </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="box box-info">
                    ...
                    <div class="box-body pad">
                      <textarea id="kabb" name="kabb" rows="2" cols="130,9" value="<?php echo $row->kabupatenn; ?>" required><?php echo $row->kabupatenn; ?></textarea>
                    </div>
                  </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="box box-info">
                    ...
                    <div class="box-body pad">
                      <textarea id="kecc" name="kecc" rows="2" cols="130,9" value="<?php echo $row->kecamatann; ?>" required><?php echo $row->kecamatann; ?></textarea>
                    </div>
                  </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="box box-info">
                    ...
                    <div class="box-body pad">
                      <textarea id="kell" name="kell" rows="2" cols="130,9" value="<?php echo $row->kelurahann; ?>" required><?php echo $row->kelurahann; ?></textarea>
                    </div>
                  </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="box box-info">
                    ...
                    <div class="box-body pad">
                      <textarea id="ps" name="ps" rows="2" cols="130,9" value="<?php echo $row->kode_pos; ?>" required><?php echo $row->kode_pos; ?></textarea>
                    </div>
                  </div>
                  </div>
                </div>
