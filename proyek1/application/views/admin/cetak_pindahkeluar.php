...
<body>
   ...
   <!--/content-inner-->
    ...
    <table width="910%">
          <legend>Cetak Data Pindah Keluar</legend><br>
              <form action="<?php print site_url();?>/Pindahdomisili/cariadmin" method=POST>
          ...
          <div align="center">
        <table width="100%" id="example1" align="center" class="table table-bordered table-striped">
          <thead>
            <tr>
