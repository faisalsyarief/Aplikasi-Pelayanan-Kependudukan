						...
						<div class="outter-wp">	
									<div class="sub-heard-part">
									   <ol class="breadcrumb m-b-0">
											...
											<li class="active">Berkas Kematian</li>
										</ol>
									</div>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <form action="<?php print site_url();?>/Berkas1/cari" method=POST>
              ...
              <table id="example1" align="center" class="table table-bordered table-striped">
                <thead>
                                        <tr>
                                            ...
                                            <th><div align="center">Fotocopy Akta Kelahiran</div></th>
                                            <th><div align="center">Fotocopy Akta Perkawinan</div></th>
                                    ...
                                    $no=1;
                                        ...
                                        <tr>
                                            ...
                                            <td><div align="center"><img src="<?php echo base_url('uploads/'.$row->ftcop_akta_kelahiran) ?>" width="150px" height="100px"><br>
                            <a class="preview" href="<?php echo base_url ('uploads/'.$row->ftcop_akta_kelahiran); ?>" rel="prettyPhoto"><i class="fa fa-eye"></i> View</a></div></td>
                                            <td><div align="center"><img src="<?php echo base_url('uploads/'.$row->ftcop_akta_perkawinan) ?>" width="150px" height="100px"><br>
                            <a class="preview" href="<?php echo base_url ('uploads/'.$row->ftcop_akta_perkawinan); ?>" rel="prettyPhoto"><i class="fa fa-eye"></i> View</a></div></td>
                                            <td><div align="center"><img src="<?php echo base_url('uploads/'.$row->ktpp) ?>" width="150px" height="100px"><br>
                            <a class="preview" href="<?php echo base_url ('uploads/'.$row->ktpp); ?>" rel="prettyPhoto"><i class="fa fa-eye"></i> View</a></div></td>
                                            <td><div align="center"><img src="<?php echo base_url('uploads/'.$row->srt_ket_rt) ?>" width="200px" height="150px"><br>
                            <a class="preview" href="<?php echo base_url ('uploads/'.$row->srt_ket_rt); ?>" rel="prettyPhoto"><i class="fa fa-eye"></i> View</a></div></td>
                                            <td><div align="center"><img src="<?php echo base_url('uploads/'.$row->srt_ket_rw) ?>" width="200px" height="150px"><br>
                            ...
                            <a href="<?php echo site_url('Berkas1/editberkas/'.$row->id_berkass)?>" type="button" class="btn btn-warning btn-circle" data-toggle="tooltip" data-placement="top" title="Edit Berkas"><i class="fa fa-edit"></i></a></div></td>
                                        </tr>
                                    <?php }
                                             }
                                                ?>
