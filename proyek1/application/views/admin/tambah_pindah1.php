...
<body>
    ...
    <ul>
      <div class="main-row"><li style="float:right"><a href="<?php echo base_url()?>index.php/Pindahdomisili/indextambah">Kembali</a></li></div>
    </ul>
...
<?php
  ...
  <div class="main">
    ...
    <form action="<?php echo base_url()?>index.php/Pindahdomisili1/simpanedittambah/<?php echo $id; ?>" method="POST">
      <table>
