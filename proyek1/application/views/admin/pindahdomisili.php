        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Data Asal</h3>

            <form action="<?php echo base_url()?>index.php/Pindahdomisili/indextambah" method=POST>
          ...
          <form action="<?php print site_url();?>/Pindahdomisili/cari" method=POST>
                ...
                <thead>
                                    ...
                                    $no=1;
                                        ...
                                        <tr>
                                            ...
                                            <td><div align="center"><?php echo $row->nm_lengkap; ?></div></td>
                                            <td><div align="center"><?php echo $row->nm_kpl_keluarga; ?></div></td>
                                            <td><div align="center"><?php echo $row->alamat; ?></div></td>
                                            <td><div align="center"><?php echo $row->rt_rw; ?></div></td>
                                            <td><div align="center"><?php echo $row->propinsi; ?></div></td>
                                            <td><div align="center"><?php echo $row->kabupaten; ?></div></td>
                                            <td><div align="center"><?php echo $row->kecematan; ?></div></td>
                                            <td><div align="center"><?php echo $row->kelurahan; ?></div></td>
                                            <td><div align="center"><?php echo $row->kd_pos; ?></div></td>
                                            <td><div align="center"><?php echo $row->telp; ?></div></td>
                                            <td class="center"><div align="center">
                            <a href="<?php echo site_url('Pindahdomisili/editpindah/'.$row->nik_pindah)?>" type="button" class="btn btn-warning btn-circle" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-edit"></i></a>
                            <a class="btn btn-danger btn-circle" data-toggle="tooltip" data-placement="top" title="Delete" href="<?php echo site_url('Pindahdomisili/hapus/'.$row->nik_pindah)?>" onclick="return confirm('Anda Yakin ?');"><i class="fa fa-times"></i>
                            </a></div></td>
                                        </tr>
                                    <?php }
                                             }
