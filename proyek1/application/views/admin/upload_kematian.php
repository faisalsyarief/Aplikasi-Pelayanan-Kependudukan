...
<body>
    ...
    <ul>
      <div class="main-row"><li style="float:right"><a href="<?php echo base_url()?>index.php/Aktakematian/indexdaftar1">Kembali</a></li></div>
    </ul>
                            ...
                            <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="form-group">
                                            <label>Fotocopy Akta Perkawinan</label>
                                            <input type="file" class="form-control" name="gambar[]" size="50">
                                        </div><br>
                                        <div class="form-group">
                                            <label>KTP</label>
