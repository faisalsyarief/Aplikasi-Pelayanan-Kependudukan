...
<body>
    ...
    <ul>
      ...
      <div class="main-row"><li style="float:right"><a href="<?php echo base_url()?>index.php/Aktakelahiran/datarkelahiran">Kembali</a></li></div>
    </ul>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="form-group">
                                            <label>Foto Surat Ket. Kelahiran</label>
