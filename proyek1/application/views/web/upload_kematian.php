...
<body>
    ...
    <ul>
      ...
      <div class="main-row"><li style="float:right"><a href="<?php echo base_url()?>index.php/Aktakematian/daftarkematian">Kembali</a></li></div>
    </ul>

  <!-- main -->
  <div class="main">
    <h1>Upload Kelengkapan <br>Akta Kematian Online</h1>
    <div class="main-row"> 
...
<?php
                  ...
                  <?php }
                                                ...
                                                ?>
          <?php echo form_open_multipart('Upload_Kematian/simpanedit/'.$id)?>
                            <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="form-group">
                                            <label>Foto Akta Perkawinan</label>
                                            <input type="file" class="form-control" name="gambar[]" size="50">
                                        </div><br>
                                        <div class="form-group">
